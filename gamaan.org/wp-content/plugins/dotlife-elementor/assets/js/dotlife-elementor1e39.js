		...
		*/
		...
		function initTimeline(timelines) {
			timelines.each(function(){
                ...
                //Added by dahdash, select last item first
                var wrapperWidth = Number(timelineComponents['timelineWrapper'].css('width').replace('px', ''));
				translateTimeline(timelineComponents, eventsMinDistance - timelineTotWidth, wrapperWidth - timelineTotWidth)
				updateFilling($('.timeline-last-item'), timelineComponents['fillingLine'], timelineTotWidth);
